...
import re
#quick fix of decimal appearing on the x axis
...
with tab1:
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            legend_title_text='')
        fig.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
...
with tab2:
    ...
    fig_area.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
    ...
    fig_line.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
...
with tab3:
    ...
    fig2.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
...
with tab4:
    ...
    fig_trend.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
...
with tab5:
    ...
    fig_line.update_xaxes(range=[year_min_sal, year_max_sal], tickmode="linear", dtick=1, tick0=year_min_sal)
    st.plotly_chart(fig_line, use_container_width=True)
...
with tab6:
    ...
    if not df_total_trend.empty:
        ...
        fig_overall.update_xaxes(range=[year_min, year_max], tickmode="linear", dtick=1, tick0=year_min)
